...
export async function configureOpenClaw(
  ...
  try {
    ...
    scriptParts.push(
      ...
      '## First Interaction',
      '',
      'When your owner messages you for the first time, read your MEMORY.md file immediately. Your first reply should:',
      '- Greet them by name (you know it from MEMORY.md)',
      '- In 1-2 sentences, show you already know what they do and what they care about — reference specific details from their profile',
      '- Suggest 2-3 concrete things you can start helping with RIGHT NOW based on what you know about them (their industry, projects, interests)',
